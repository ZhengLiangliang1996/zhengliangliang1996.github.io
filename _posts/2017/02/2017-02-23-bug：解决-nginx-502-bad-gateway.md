...
![15094716_nehH.png](images/15094716_nehh.png)
...
**将listen设置为9000,即改成listen=9000 如图![3.PNG](images/3.png)**

**重启php5-fpm与nginx后，恢复。进行项目git clone 再 migrate和seeder就看到原来的考试系统了![QQ图片20170223221246.png](images/qqe59bbee7898720170223221246.png)**
