...
1、文件上传的前提： a、表单的method必须是post b、表单的enctype属性必须是multipart/form-data c、表单中提供input type="file" ![1654.png](images/1654.png)
...
![1651212.png](images/1651212.png)
...
57 			String fileName \= item.getName();//上传的文件的文件名  C:\\Users\\wzhting\\Desktop\\a.txt  a.txt(浏览器不同)
58 			if(fileName!=null){
...
**2.重名文件被覆盖**![16523.png](images/16523.png)
...
77 			String fileName \= item.getName();//上传的文件的文件名  C:\\Users\\wzhting\\Desktop\\a.txt  a.txt(浏览器不同)
