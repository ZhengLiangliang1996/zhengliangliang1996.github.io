...
代码:代码思想比较简单，直接copy了一个上来~原博主[网站](http://www.cnblogs.com/Anker/archive/2013/01/25/2877311.html)
 ...
 5 void get\_max\_min(int \*datas,int length,int\* ptrmax,int\* ptrmin)
 6 {
...
51     get\_max\_min(datas,6,&max,&min);
...
伪代码:
 ...
 1 RANDOMIZED\_SELECT(A,p,r,i)
 2      if p\==r
 3         then return A\[p\]
 4      q \= RANDOMIZED\_PARTITION(A,p,r)
 5      k \= q\-p+1;
 6      if i\==k
 7         then return A\[q\]
 8      else  if i<k
 9          then return RANDOMIZED\_SELECT(A,p,q\-1,i)
10       else
11           return RANDOMIZED\_SELECT(A,p,q\-1,i\-k)
