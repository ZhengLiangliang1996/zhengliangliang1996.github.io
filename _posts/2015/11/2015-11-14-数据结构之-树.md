...
[![2015-10-17_195036](images/2015-10-17_195036.png)](https://zhengliangliang.files.wordpress.com/2015/10/2015-10-17_195036.png)
...
     [![2015-10-17_195812](images/2015-10-17_195812.png)](https://zhengliangliang.files.wordpress.com/2015/10/2015-10-17_195812.png)**二.专业词汇**

 [![2015-10-17_195954](images/2015-10-17_195954.png)](https://zhengliangliang.files.wordpress.com/2015/10/2015-10-17_195954.png)
...
[![2015-10-17_202903](images/2015-10-17_202903.png)](https://zhengliangliang.files.wordpress.com/2015/10/2015-10-17_202903.png)一个倒二叉树族谱（图片来自维基百科）

[![2015-10-17_203047](images/2015-10-17_203047.png)](https://zhengliangliang.files.wordpress.com/2015/10/2015-10-17_203047.png)

由图可知，二叉树是相对稳定的树形结构。

**五.二叉树的一些属性**

[![2015-10-17_203340](images/2015-10-17_203340.png)](https://zhengliangliang.files.wordpress.com/2015/10/2015-10-17_203340.png)
...
#ifndef \_BINTREE\_H\_\_
#define \_BINTREE\_H\_\_
#include <fstream>
...
class BinTree{
private:
	struct tree\_node  //it can name the struct on the head without name it in the tail
	{
		tree\_node\* left;
		tree\_node\* right;
		int data;
...
public:
	...
	void print\_Preorder();
	void Preorder(tree\_node \*);
	bool Search(int);
	void Remove(int);
};

void BinTree::Insert(int d){
	tree\_node \* t \= new tree\_node;
	tree\_node \* parent \= NULL;
	t\->data \= d;
	t\->left \= NULL;
	t\->right \= NULL;
...
void BinTree::print\_Preorder()
{
	Preorder(root);
}

void BinTree::Preorder(tree\_node\* p)//avoid inputing tree\_node\*p in main ,so i add an print\_inorder!
{
	if (p != NULL)
	{
