...
![2015-12-12_183642](images/2015-12-12_183642.png)
...
![timsort-algorythm-1st-screenshot.png](images/timsort-algorythm-1st-screenshot.png)
...
![2015-12-12_193905](images/2015-12-12_193905.png)
...
void SelectionSort(int arr\[\], int n){
	...
	for (i \= 0; i < n \- 1; i++)
	{
		min\_key \= i;
		for (j \= i + 1; j < n; j++)
			if (arr\[j\] < arr\[min\_key\])
				min\_key \= j;
			swap(&arr\[min\_key\], &arr\[i\]);
	}
}
// Driver program to test above functions
int main()
...
![2015-12-12_195933](images/2015-12-12_195933.png)
...
![2015-12-12_212325](images/2015-12-12_212325.png)
...
If r > l
 ...
 ![2015-12-12_215635](images/2015-12-12_215635.png)
...
![2015-12-13_195800](images/2015-12-13_195800.png)
