...
![2015-12-05_135638](images/2015-12-05_135638.png)
...
public:	//data member
	...
	//function member
	VNode(DataType val \= INIT\_DATA, bool flag \= false) :data(val), visited(flag){}    //CONSTRUCTOR
	void Visit(){
		cout << data << " ";
	}
...
#ifndef \_GRAPH\_\_H\_\_
#define \_GRAPH\_\_H\_\_
#include <iostream>
#include <queue>
#include <vector>
using namespace std;
typedef int DataType;
const DataType INIT\_DATA \= -1;
const int NO\_NODE \= -1;
const int NO\_EDGE \= -2;
...
![2015-12-06_095930](images/2015-12-06_095930.png)
  ...
  while (!queue.empty())
  {
    ...
    for (i \= adj\[s\].begin(); i != adj\[s\].end(); ++i)
    {
      if (!visited\[\*i\])
      {
        ...
        queue.push\_back(\*i);//这里我有个疑问 这一个点其实可以不需要的
      }
    }
  }
}
...
![2015-12-06_111355](images/2015-12-06_111355.png)
...
![MST_kruskal_en](images/mst_kruskal_en.gif)
...
![2015-12-06_120810](images/2015-12-06_120810.png)
